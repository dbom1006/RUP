		...
		<div class="col-md-9">
			...
			<div class="row">
				...
				<div class="col-md-10">
					...
					<form class="form-horizontal" role="form" method="POST" action="ThemSanPham?iduser=<%=session.getAttribute("iduser")%>">
					  <div class="form-group">
					    <label for="inputEmail3" class="col-sm-2 control-label">Tên Sản Phẩm</label>
					    <div class="col-sm-10">
					      <input type="text" class="form-control" name="tensanpham" id="inputEmail3"  placeholder="Tên Sản Phẩm">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputPassword3" class="col-sm-2 control-label">Mô tả</label>
					    <div class="col-sm-10">
					    <input type="text" class="form-control" name="mota" id="inputEmail3"  placeholder="Tên Sản Phẩm">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" class="form-control" name="hinhanh" id="inputPassword3"  placeholder="Hình Ảnh">
					    </div>
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text" class="form-control" name="tag" id="inputPassword3"  placeholder="Tag">
					    </div>
					  </div>
